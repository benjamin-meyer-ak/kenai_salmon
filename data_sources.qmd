...
# question - what would this harvest figure look like broken down by species? Also for vs total run for each spp
...
Idea for NEW overall fig - stacked bar plot of harvest by fishery (& sub stack by species?) superimposed with total harvest ... can visualize remaining escaement in context of harvest.
