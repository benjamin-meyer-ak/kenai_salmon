...
NOTE - chaneg data sources to secondary focus; most readers will not want to dig into details of data sources
...
ggplotly(
  ...
  xlab("") +
  ylab("Total Harvest") +
  ggtitle("Northern Kenai Peninsula / Upper Cook Inlet\nTotal Salmon Harvest 1966-2022 (All Species)")
)
