...
puharvest_post1996 <- read.csv(dir) %>%
  clean_names() %>%
  # make class consistent with other fisheries results
  transform(unknown = as.character(unknown)) %>%
  # prep format
  ...
  select(-page,-source,-fishery) 
  
# replace all NA in count column with zero; need to figure out w/ how to keep in pipeline
puharvest_post1996[is.na(puharvest_post1996)] <- "0"
...
# error: data post 2015 is gett converted from 0 to NA in the simamrise ste ?!?!?!?!?
...
Next: find updated data sources to 2022 or 2023
comm?: https://www.adfg.alaska.gov/static/regulations/regprocess/fisheriesboard/pdfs/2023-2024/uci/fmr_22-16.pdf
